...
/**
 * This function is the interface to the frontend and is called from it. This is only a one way
...
class WebAppInterface(
     ...
     * Please be very careful when using variables in the eval() statements, as unsanitized user input
     * might lead to arbitrary code execution in the frontend.
